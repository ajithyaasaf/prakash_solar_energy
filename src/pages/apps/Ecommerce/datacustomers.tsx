...
const customers: CustomersItems[] = [
  ...
  },
  {
    ...
    name: "Siti Nisha",
    phone: "(44) 2345678",
    email: "sitinisha@tamilmail.com",
    location: "Coimbatore",
    created_on: "7/8/2019",
    status: "Blocked",
    avatar:
      "https://robohash.org/voluptatemvelitfugiat.png?size=60x60&set=set1",
  },
  {
    id: "3",
    name: "Rajesh Babu",
    phone: "(44) 3456789",
    email: "rajeshbabu@tamilmail.com",
    location: "Madurai",
    created_on: "7/10/2019",
    status: "Active",
    avatar: "https://robohash.org/etadipisciut.png?size=60x60&set=set1",
  },
  {
    id: "4",
    name: "Pooja Devi",
    phone: "(44) 4567890",
    email: "poojadevi@tamilmail.com",
    location: "Tiruchirappalli",
    created_on: "7/11/2019",
    status: "Blocked",
    avatar: "https://robohash.org/eligendiveritatisrem.png?size=60x60&set=set1",
  },
  {
    id: "5",
    name: "Mohan Raj",
    phone: "(44) 5678901",
    email: "mohanraj@tamilmail.com",
    location: "Chennai",
    created_on: "7/12/2019",
    status: "Active",
    avatar:
      "https://robohash.org/voluptatemautemdolorum.png?size=60x60&set=set1",
  },
  {
    id: "6",
    name: "Preetha Kumar",
    phone: "(44) 6789012",
    email: "preethakumar@tamilmail.com",
    location: "Erode",
    created_on: "7/13/2019",
    status: "Active",
    avatar:
      "https://robohash.org/quasrepudiandaemagnam.png?size=60x60&set=set1",
  },
  {
    id: "7",
    name: "Vijayan Murugan",
    phone: "(44) 7890123",
    email: "vijayanmurugan@tamilmail.com",
    location: "Kochi",
    created_on: "7/14/2019",
    status: "Active",
    avatar: "https://robohash.org/sintconsequunturquas.png?size=60x60&set=set1",
  },
  {
    id: "8",
    name: "Sree Lakshmi",
    phone: "(44) 8901234",
    email: "sreelakshmi@tamilmail.com",
    location: "Trichy",
    created_on: "7/16/2019",
    status: "Blocked",
    avatar: "https://robohash.org/quodnatusid.png?size=60x60&set=set1",
  },
  {
    id: "9",
    name: "Anjali Ramesh",
    phone: "(44) 9012345",
    email: "anjaliramesh@tamilmail.com",
    location: "Chidambaram",
    created_on: "7/17/2019",
    status: "Active",
    avatar:
      "https://robohash.org/utblanditiisblanditiis.png?size=60x60&set=set1",
  },
  {
    id: "10",
    name: "Saranya Subramaniam",
    phone: "(44) 1234567",
    email: "saranayasubramaniam@tamilmail.com",
    location: "Vellore",
    created_on: "7/18/2019",
    status: "Active",
    avatar:
      "https://robohash.org/voluptatibusdoloromolestias.png?size=60x60&set=set1",
  },
  {
    id: "11",
    name: "Sathish Kumar",
    phone: "(44) 2345678",
    email: "sathishkumar@tamilmail.com",
    location: "Chennai",
    created_on: "7/20/2019",
    status: "Blocked",
    avatar:
      "https://robohash.org/repudiandaevelitfugiat.png?size=60x60&set=set1",
  },
  {
    id: "12",
    name: "Rohini Raj",
    phone: "(44) 3456789",
    email: "rohiniraj@tamilmail.com",
    location: "Kanchipuram",
    created_on: "7/21/2019",
    status: "Active",
    avatar: "https://robohash.org/voluptatemetadipisci.png?size=60x60&set=set1",
  },
  {
    id: "13",
    name: "Manoj Kumar",
    phone: "(44) 4567890",
    email: "manojkumar@tamilmail.com",
    location: "Tiruvallur",
    created_on: "7/22/2019",
    status: "Blocked",
    avatar: "https://robohash.org/quasrepudiandae.png?size=60x60&set=set1",
  },
  {
    id: "14",
    name: "Neelima Natarajan",
    phone: "(44) 5678901",
    email: "neelimanatarajan@tamilmail.com",
    location: "Tirupur",
    created_on: "7/23/2019",
    status: "Active",
    avatar: "https://robohash.org/etnonvoluptas.png?size=60x60&set=set1",
  },
  {
    id: "15",
    name: "Ravi Kumar",
    phone: "(44) 6789012",
    email: "ravikumar@tamilmail.com",
    location: "Vellore",
    created_on: "7/24/2019",
    status: "Active",
    avatar: "https://robohash.org/suscipitrepudiandae.png?size=60x60&set=set1",
  },
  {
    id: "16",
    name: "Sundari Rajendran",
    phone: "(44) 7890123",
    email: "sundarirajendran@tamilmail.com",
    location: "Chennai",
    created_on: "7/25/2019",
    status: "Blocked",
    avatar:
      "https://robohash.org/excepturisuntvoluptatem.png?size=60x60&set=set1",
  },
  {
    id: "17",
    name: "Karthik Sundaram",
    phone: "(44) 8901234",
    email: "karthiksundaram@tamilmail.com",
    location: "Chidambaram",
  ...
  },
  {
    ...
    name: "Vijaya Lakshmi",
    phone: "(44) 9012345",
    email: "vijayalakshmi@tamilmail.com",
    location: "Tanjore",
  ...
  },
  {
    ...
    name: "Rajesh Kumar",
    phone: "(44) 1234567",
    email: "rajeshkumar@tamilmail.com",
    location: "Tirunelveli",
    created_on: "7/29/2019",
    status: "Blocked",
  ...
  },
  {
    ...
    name: "Madhavi Rani",
    phone: "(44) 2345678",
    email: "madhavirani@tamilmail.com",
    location: "Cuddalore",
    created_on: "7/30/2019",
    status: "Active",
  ...
  },
  {
    ...
    phone: "(44) 4567890",
    email: "arunachalamnatarajan@tamilmail.com",
    location: "Tiruvallur",
    created_on: "8/2/2019",
    status: "Blocked",
  ...
  {
    id: "23",
    name: "Radhika Jayapalan",
    phone: "(44) 5678901",
    email: "radhikajayapalan@tamilmail.com",
    location: "Vellore",
    created_on: "8/4/2019",
    status: "Active",
    avatar:
  ...
  },
  {
    ...
    name: "Kasi Annamalai",
    phone: "(44) 6789012",
    email: "kasiannamalai@tamilmail.com",
    location: "Thanjavur",
    created_on: "8/5/2019",
    status: "Active",
    avatar: "https://robohash.org/voluptatemutadipisci.png?size=60x60&set=set1",
  },
  {
    id: "25",
    name: "Subramaniam Ayyappan",
    phone: "(44) 7890123",
    email: "subramaniamayyappan@tamilmail.com",
    location: "Sivakasi",
    created_on: "8/6/2019",
    status: "Blocked",
    avatar: "https://robohash.org/voluptatemutadipisci.png?size=60x60&set=set1",
